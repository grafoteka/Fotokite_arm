...
int main(int argc, char** argv)
{
  ...
  //RobotTrajectoryFollower RobotTrajectoryFollower("/fotokite_arm/wrist_group_controller/joint_trajectory_action");
  RobotTrajectoryFollower RobotTrajectoryFollower("/fotokite_arm/fotokite_group_controller/joint_trajectory_action");
  ros::spin();
